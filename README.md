...
## Architecture
- **Ingestion Layer (`/src` & `main.py`)**: Decoupled Python ETL pipeline leveraging SQLAlchemy, Pandas, and Faker to seed a relational PostgreSQL schema preserving foreign keys, chronological logic, and realistic weighted distributions, and **PII data masking (SSN obfuscation ***-**-4 digits of syntatic SSN)** for regulatory compliance.
...
## Tech Stack
- **Database**: PostgreSQL
- **Languages & Frameworks**: Python 3.14(compatible with 3.11+), SQLAlchemy, Pandas, psycopg2-binary
